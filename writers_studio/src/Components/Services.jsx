         ...
         <div className="container">
            <div className="row">
               <div className="col-sm-12">
                  ...
                  <p className="services_text">Writes Studio the tools that helps a lot.. </p>
               </div>
            </div>
               ...
               <div className="row">
                  <div className="col-lg-4 col-sm-12 col-md-4">
                     <div className="box_main active">
                        ...
                        <h3 className="decorate_text">Create a small Story</h3>
                        <p className="tation_text">Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                        <div className="readmore_bt"><a href="#">Explore</a></div>
                     </div>
                  </div>
                  <div className="col-lg-4 col-sm-12 col-md-4">
                     <div className="box_main">
                        ...
                        <h3 className="decorate_text">Create content</h3>
                        <p className="tation_text">Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                        <div className="readmore_bt"><a href="#">Explore</a></div>
                     </div>
                  </div>
                  <div className="col-lg-4 col-sm-12 col-md-4">
                     <div className="box_main">
                        ...
                        <h3 className="decorate_text">Create Blog</h3>
                        <p className="tation_text">Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                        <div className="readmore_bt"><a href="#">Explore</a></div>
                     </div>
                  </div>
